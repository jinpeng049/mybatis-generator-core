...
public interface CompilationUnit {
    ...
    List<IntrospectedColumn> primaryKeyColumns(List<IntrospectedColumn> primaryKeyColumns);
    List<IntrospectedColumn> baseColumns(List<IntrospectedColumn> baseColumns);
    List<IntrospectedColumn> blobColumns(List<IntrospectedColumn> blobColumns);
}
