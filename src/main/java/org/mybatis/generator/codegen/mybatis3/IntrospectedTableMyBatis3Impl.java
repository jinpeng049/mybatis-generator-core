...
public class IntrospectedTableMyBatis3Impl extends IntrospectedTable {
	...
	for (AbstractJavaGenerator javaGenerator : javaModelGenerators) {
		...
		compilationUnit.tableName(tableName);
		compilationUnit.primaryKeyColumns(getPrimaryKeyColumns());
		compilationUnit.baseColumns(getBaseColumns());
		compilationUnit.blobColumns(getBLOBColumns());
